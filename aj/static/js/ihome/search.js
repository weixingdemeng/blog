...
//    console.log(keys)
    aid = keys[0].split('=')[1]
    aname = keys[1].split('=')[1]
    sd = keys[2].split('=')[1]
    ed = keys[3].split('=')[1]
    data_list = [aid, aname, sd, ed]
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            for (var i=0; i<data.houses.length; i++){
                html += '<li class="house-item"><a href="/home/detail/'+ data.houses[i].id +'/"><img style="height:200px" src="/static/media/'+ data.houses[i].image+'"></a><div class="house-desc"> <div class="landlord-pic"><img src="/static/images/landlord01.jgp"></div><div class="house-price">￥<span>'+ data.houses[i].price +'</span>/晚</div><div class="house-intro"><span class="house-title">房屋标题:'+data.houses[i].title+'</span><em>出租'+ data.houses[i].room +'间 - 1次入住 - '+ data.houses[i].address +'</em></div></div></li>'
            }
            $('.house-list').html('<ul class="house-list">' + html + '</ul>')
        },
        error:function(data){
            alert('请求失败')
        }
